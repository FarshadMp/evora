...
<head>
    ...
    <title>Bestsellers - ÉVORA Luxury Jewelry</title>
    <meta name="description"
        content="Discover our bestselling luxury jewelry pieces at ÉVORA. Handcrafted pieces that customers love.">
...
<body class="bg-evora-beige">
    ...
    <section class="py-4 px-4 sm:px-6 md:px-8 bg-evora-beige">
        <div class="space-x-2 text-xs text-primary">
            ...
            <span class="text-primary font-medium uppercase">Bestsellers</span>
            </nav>
    </section>
    ...
    <section class="py-8 sm:py-12 md:py-8 px-4 sm:px-6 md:px-8 bg-evora-beige">
        <div class="text-left">
            <h1 class="text-3xl sm:text-4xl md:text-4xl lg:text-4xl font-light text-primary mb-4">BESTSELLERS</h1>
            <p class="text-sm text-primary font-light">
                Dermatologist-tested and clinically proven. Meet the bestsellers, aka. best friends.
            </p>
        </div>
    </section>
    ...
    // Get bestseller products based on filters
    $products = getAllProducts($category, $sort, null, 'bestsellers');
    ?>
    <section class="pb-8 sm:pb-12 md:pb-16 pt-5 px-4 sm:px-6 md:px-8 bg-evora-beige">
        ...
        if (!empty($products)) {
            ...
            echo '<div class="text-center text-gray-500 py-8">No products available</div>';
        }
        ?>
